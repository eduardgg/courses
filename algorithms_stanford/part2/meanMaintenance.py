print(sum([6331, 2793, 2793, 2793, 2793, 1640, 2793, 2303, 2793, 2303]))
print(sum([6331, 2793, 6331, 2793, 6331, 1640, 2793, 2303, 2793, 2303]))
...
def main():
    ...
    lines = open('medianData.txt').read().splitlines()
